			...
			<div class="content" style="padding-bottom: 50px;">
				<div class="card">
					...
					<div class="card-body">
						...
						<br><br>
						<h3><button class="btn btn-warning btn-block btn-lg"onclick="location='/Setting/TheMypageCheck.do'">마이페이지</button></h3>
						<br><br>
						<h3><button class="btn btn-warning btn-block btn-lg" onclick="location='/Setting/TheReViewTutorial.do'">튜토리얼 다시보기</button></h3>
						<br><br>
						<h3><button class="btn btn-warning btn-block btn-lg" onclick="location='/Setting/TheAppIntroduction.do'">앱 소개</button></h3>
						<br><br>

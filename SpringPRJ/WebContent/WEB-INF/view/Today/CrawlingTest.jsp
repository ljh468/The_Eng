...
<%
	String contents = (String)request.getAttribute("news_contents");
...
<body class="">
	...
	<div class="wrapper ">
		...
		<div class="main-panel">
			...
			<div class="content">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="m-4" style="font-size:1.75em">
			...
			<input type="button" class="btn btn-warning btn-block btn-lg" value="Next" onclick="location='/Today/TodaySentence.do'">
